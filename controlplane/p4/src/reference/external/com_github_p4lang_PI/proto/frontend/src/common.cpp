...
Code check_proto_bytestring(const std::string &str, size_t nbits) {
  ...
  // BEGIN
  std::cout << "common::check_proto_bytestring -> the following values should be similar" << std::endl;
  ...
  // BEGIN
  std::cout << "common::check_proto_bytestring -> not_zero_pos should be less than zero_nbits" << std::endl;
