...
# Available in the mn-stratum container (file is "stratum" in original container, but renamed in our container)
try:
    from stratum import StratumBmv2Switch
except:
    from mn_stratum import StratumBmv2Switch
...
class TutorialTopo(Topo):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Leaves
        # gRPC port 50001
        s1 = self.addSwitch("s1", cls=StratumBmv2Switch, cpuport=CPU_PORT, mac="00:00:00:00:00:04")
        # gRPC port 50002
...
hosts = {"no-offload-host": IPv6Host}
